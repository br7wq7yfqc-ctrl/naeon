...
**Clash нативен; бар арены — Predecessor/Paragon, не Arena Commander:** `docs/design/ARENA_PREDECESSOR_BENCHMARK.md` (AR-A…AR-Y; код арены не вытесняет OS-A).  
**Стратегия — третий бар, не Clash и не полёт OPEN SPACE:** `docs/design/BASE_STATION_STRATEGY.md` (ST-A…ST-K built: overlay, extractor, print, hangar, orbital cluster, CX↔GR owner swap, own factory print, one pad turret, one pad storage, one pad hangar stub, one orbital hangar stub).  
...
ST-A…ST-K / IN-A…F / WF-A / Q-A / Q-B / Q-C / Q-D / Q-E / HF-A / HF-B / HF-C / PV-A built.  
...
**Бар:** `docs/design/BASE_STATION_STRATEGY.md` (ST-A…ST-K built). Overlay на загруженном теле ARK — не карта галактики.
