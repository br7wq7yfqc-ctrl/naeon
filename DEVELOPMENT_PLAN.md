...
- Fleet system (до 10–15 кораблей, flagship overlay) — **FL-A + FL-B + FL-C built:** three extra allied pips on ST-A Strategy overlay (FL-A existing pad-visitor `NpcPilot` / NP-A hull; FL-B / FL-C SoftNet visual, same grammar; cap 4 = player + 3; SoftKnowledge / HUD `FLEET n/4`; click/select ≠ combat; host Pulse / occupy; not 10–15 ships; not a second OpenSpace; not ENet)
