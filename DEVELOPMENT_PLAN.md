...
**Clash нативен; бар арены — Predecessor/Paragon, не Arena Commander:** `docs/design/ARENA_PREDECESSOR_BENCHMARK.md` (AR-A…AR-M; код арены не вытесняет OS-A).  
...
- Fleet system (до 10–15 кораблей, flagship overlay) — **FL-A + FL-B + FL-C + FL-D + FL-E + FL-F + FL-G + FL-H built:** eight extra allied pips on ST-A Strategy overlay (FL-A existing pad-visitor `NpcPilot` / NP-A hull; FL-B / FL-C / FL-D / FL-E / FL-F / FL-G / FL-H SoftNet visual, same grammar; cap 9 = player + 8 toward 10–15; SoftKnowledge / HUD `FLEET n/9`; click/select ≠ combat; host Pulse / occupy; not 10–15 ships yet; not a second OpenSpace; not ENet)
