...
- Fleet system (до 10–15 кораблей, flagship overlay) — **FL-A + FL-B + FL-C + FL-D + FL-E built:** five extra allied pips on ST-A Strategy overlay (FL-A existing pad-visitor `NpcPilot` / NP-A hull; FL-B / FL-C / FL-D / FL-E SoftNet visual, same grammar; cap 6 = player + 5 toward 10–15; SoftKnowledge / HUD `FLEET n/6`; click/select ≠ combat; host Pulse / occupy; not 10–15 ships yet; not a second OpenSpace; not ENet)
