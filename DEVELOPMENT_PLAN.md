...
- Fleet system (до 10–15 кораблей, flagship overlay) — **FL-A + FL-B + FL-C + FL-D built:** four extra allied pips on ST-A Strategy overlay (FL-A existing pad-visitor `NpcPilot` / NP-A hull; FL-B / FL-C / FL-D SoftNet visual, same grammar; cap 5 = player + 4; SoftKnowledge / HUD `FLEET n/5`; click/select ≠ combat; host Pulse / occupy; not 10–15 ships; not a second OpenSpace; not ENet)
