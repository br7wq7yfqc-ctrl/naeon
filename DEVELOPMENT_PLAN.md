...
- Fleet system (до 10–15 кораблей, flagship overlay) — **FL-A + FL-B + FL-C + FL-D + FL-E + FL-F + FL-G built:** seven extra allied pips on ST-A Strategy overlay (FL-A existing pad-visitor `NpcPilot` / NP-A hull; FL-B / FL-C / FL-D / FL-E / FL-F / FL-G SoftNet visual, same grammar; cap 8 = player + 7 toward 10–15; SoftKnowledge / HUD `FLEET n/8`; click/select ≠ combat; host Pulse / occupy; not 10–15 ships yet; not a second OpenSpace; not ENet)
