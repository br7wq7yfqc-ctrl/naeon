...
- AI-bots (Cybernex animal-robots + gROT swarms) — BehaviorTree / Navigation — **BT-A built:** one pad-guard on an occupied unnamed pad (tiny 3-state GDScript BT: patrol / engage Pulse / return-to-pad; host authority; Pulse 11; Knowledge labels only; PV-A rival stays distinct; G5 closed; not Clash waves)
