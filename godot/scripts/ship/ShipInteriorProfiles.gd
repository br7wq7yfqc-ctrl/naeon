	...
	match id:
		sniper_gunnery:
			return {
				...
				props: [
					{rel: props/ship_cockpit_console/%s_lod1.glb, pos: Vector3(0, 0, -0.3), s: 0.9},
					{rel: props/holo_projector/%s_lod2.glb, pos: Vector3(0, 0, 8), s: 1.0},
					{rel: props/control_console/%s_lod1.glb, pos: Vector3(1.5, 0, 9), s: 0.8},
				],
		...
		hauler_cargo:
			return {
				...
				props: [
					{rel: props/ship_cockpit_console/%s_lod1.glb, pos: Vector3(0, 0, 0), s: 0.85},
					{rel: props/storage_barrel/%s_lod2.glb, pos: Vector3(2, 0, 12), s: 0.7},
					{rel: props/sci_fi_crate/%s_lod2.glb, pos: Vector3(-2, 0, 14), s: 0.8},
					{rel: props/sci_fi_crate/%s_lod2.glb, pos: Vector3(2, 0, 16), s: 0.8},
				],
				seat: Vector3(0, 1.0, 0.5),
				hatch: Vector3(0, 1.2, 23.5),
			}
		_:
			# scout_single — default single-seat
			return {
				id: scout_single,
				rooms: [
				...
				props: [
					{rel: props/ship_cockpit_console/%s_lod1.glb, pos: Vector3(0, 0, -0.4), s: 0.85},
					{rel: props/control_console/%s_lod2.glb, pos: Vector3(1.0, 0, 0.8), s: 0.55},
					{rel: props/storage_barrel/%s_lod2.glb, pos: Vector3(-1.1, 0, 5.5), s: 0.45},
				],
