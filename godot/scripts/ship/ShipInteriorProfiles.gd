...
## Catalog of interior room graphs per hull — pilot + MC-A gunner + MC-C engineer + MC-D scanner.
	...
	match id:
		"sniper_gunnery":
			return {
				...
				"scanner_seat": Vector3(0.0, 1.0, 3.2),
		...
		"hauler_cargo":
			return {
				...
				"scanner_seat": Vector3(0.0, 1.0, 3.3),
		...
		_:
			return {
				...
				"scanner_seat": Vector3(0.0, 0.95, 3.0),
