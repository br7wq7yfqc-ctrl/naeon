...
## FL-C: a third extra allied pip — same SoftNet / NP-A visual grammar.
...
func setup(host_pad: Node3D) -> void:
	...
	refresh_labels()
	set_process(true)
	print("[PadTraffic] host=", _host_name, " guard=1 visitor=1 surface=1 rival=1 softnet=1 swarm=3 pack=3 fleet=13")
...
func fleet_guest_c() -> Node3D:
	## FL-C: third SoftNet visual ally. Same NP-A hold grammar. Not Ship.tscn.
	if _fleet_ally_c != null and is_instance_valid(_fleet_ally_c):
		return _fleet_ally_c
	var n: Node = get_node_or_null("FleetAllyVisualC")
	if n is Node3D and is_instance_valid(n):
		_fleet_ally_c = n as Node3D
		return _fleet_ally_c
	_spawn_fleet_ally_c()
	if _fleet_ally_c != null and is_instance_valid(_fleet_ally_c):
		return _fleet_ally_c
...
func fleet_guest_d() -> Node3D:
	## FL-D: fourth SoftNet visual ally. Same NP-A hold grammar. Not Ship.tscn.
	if _fleet_ally_d != null and is_instance_valid(_fleet_ally_d):
		return _fleet_ally_d
	var n: Node = get_node_or_null("FleetAllyVisualD")
	if n is Node3D and is_instance_valid(n):
		_fleet_ally_d = n as Node3D
		return _fleet_ally_d
	_spawn_fleet_ally_d()
	if _fleet_ally_d != null and is_instance_valid(_fleet_ally_d):
		return _fleet_ally_d
...
func fleet_guest_f() -> Node3D:
	## FL-F: sixth SoftNet visual ally. Same NP-A hold grammar. Not Ship.tscn.
	if _fleet_ally_f != null and is_instance_valid(_fleet_ally_f):
		return _fleet_ally_f
	var n: Node = get_node_or_null("FleetAllyVisualF")
	if n is Node3D and is_instance_valid(n):
		_fleet_ally_f = n as Node3D
		return _fleet_ally_f
	_spawn_fleet_ally_f()
	if _fleet_ally_f != null and is_instance_valid(_fleet_ally_f):
		return _fleet_ally_f
...
func fleet_guest_g() -> Node3D:
	## FL-G: seventh SoftNet visual ally. Same NP-A hold grammar. Not Ship.tscn.
	if _fleet_ally_g != null and is_instance_valid(_fleet_ally_g):
		return _fleet_ally_g
	var n: Node = get_node_or_null("FleetAllyVisualG")
	if n is Node3D and is_instance_valid(n):
		_fleet_ally_g = n as Node3D
		return _fleet_ally_g
	_spawn_fleet_ally_g()
	if _fleet_ally_g != null and is_instance_valid(_fleet_ally_g):
		return _fleet_ally_g
...
func fleet_guest_h() -> Node3D:
	## FL-H: eighth SoftNet visual ally. Same NP-A hold grammar. Not Ship.tscn.
	if _fleet_ally_h != null and is_instance_valid(_fleet_ally_h):
		return _fleet_ally_h
	var n: Node = get_node_or_null("FleetAllyVisualH")
	if n is Node3D and is_instance_valid(n):
		_fleet_ally_h = n as Node3D
		return _fleet_ally_h
	_spawn_fleet_ally_h()
	if _fleet_ally_h != null and is_instance_valid(_fleet_ally_h):
		return _fleet_ally_h
...
func fleet_guest_j() -> Node3D:
	## FL-J: tenth SoftNet visual ally. Same NP-A hold grammar. Not Ship.tscn.
	if _fleet_ally_j != null and is_instance_valid(_fleet_ally_j):
		return _fleet_ally_j
	var n: Node = get_node_or_null("FleetAllyVisualJ")
	if n is Node3D and is_instance_valid(n):
		_fleet_ally_j = n as Node3D
		return _fleet_ally_j
	_spawn_fleet_ally_j()
	if _fleet_ally_j != null and is_instance_valid(_fleet_ally_j):
		return _fleet_ally_j
...
func fleet_guest_k() -> Node3D:
	## FL-K: eleventh SoftNet visual ally. Same NP-A hold grammar. Not Ship.tscn.
	if _fleet_ally_k != null and is_instance_valid(_fleet_ally_k):
		return _fleet_ally_k
	var n: Node = get_node_or_null("FleetAllyVisualK")
	if n is Node3D and is_instance_valid(n):
		_fleet_ally_k = n as Node3D
		return _fleet_ally_k
	_spawn_fleet_ally_k()
	if _fleet_ally_k != null and is_instance_valid(_fleet_ally_k):
		return _fleet_ally_k
...
func fleet_guest_l() -> Node3D:
	## FL-L: twelfth SoftNet visual ally. Same NP-A hold grammar. Not Ship.tscn.
	if _fleet_ally_l != null and is_instance_valid(_fleet_ally_l):
		return _fleet_ally_l
	var n: Node = get_node_or_null("FleetAllyVisualL")
	if n is Node3D and is_instance_valid(n):
		_fleet_ally_l = n as Node3D
		return _fleet_ally_l
	_spawn_fleet_ally_l()
	if _fleet_ally_l != null and is_instance_valid(_fleet_ally_l):
		return _fleet_ally_l
...
func fleet_guest_m() -> Node3D:
	## FL-M: thirteenth SoftNet visual ally. Same NP-A hold grammar. Not Ship.tscn.
	if _fleet_ally_m != null and is_instance_valid(_fleet_ally_m):
		return _fleet_ally_m
	var n: Node = get_node_or_null("FleetAllyVisualM")
	if n is Node3D and is_instance_valid(n):
		_fleet_ally_m = n as Node3D
		return _fleet_ally_m
	_spawn_fleet_ally_m()
	if _fleet_ally_m != null and is_instance_valid(_fleet_ally_m):
		return _fleet_ally_m
...
func _spawn_fleet_ally_c() -> void:
	## FL-C: third SoftNet visual hull. Same visitor-hold grammar. Not a third Ship.
	var P0 = load("res://scripts/world/P0Slice.gd")
	if P0 != null and not bool(P0.FL_C_FLEET):
		return
	if _fleet_ally_c != null and is_instance_valid(_fleet_ally_c):
		return
	if get_node_or_null("FleetAllyVisualC") != null:
		_fleet_ally_c = get_node_or_null("FleetAllyVisualC") as Node3D
		return
	var v := Node3D.new()
	v.name = "FleetAllyVisualC"
	v.set_meta("pad_traffic_role", "fleet_ally_c")
	v.set_meta("fleet_member", true)
	v.set_meta("softnet_visual", true)
	v.set_meta("combat_authority", "host")
	v.set_meta("occupy_authority", "host")
	...
	lab.position = Vector3(0, 2.4, 0)
	lab.text = _SoftK.fleet_label()
	lab.modulate = Color(0.85, 0.7, 1.0)
	v.add_child(lab)


func _spawn_fleet_ally_d() -> void:
	## FL-D: fourth SoftNet visual hull. Same visitor-hold grammar. Not a fourth Ship.
	var P0 = load("res://scripts/world/P0Slice.gd")
	if P0 != null and not bool(P0.FL_D_FLEET):
		return
	if _fleet_ally_d != null and is_instance_valid(_fleet_ally_d):
		return
	if get_node_or_null("FleetAllyVisualD") != null:
		_fleet_ally_d = get_node_or_null("FleetAllyVisualD") as Node3D
		return
	var v := Node3D.new()
	v.name = "FleetAllyVisualD"
	v.set_meta("pad_traffic_role", "fleet_ally_d")
	v.set_meta("fleet_member", true)
	v.set_meta("softnet_visual", true)
	v.set_meta("combat_authority", "host")
	v.set_meta("occupy_authority", "host")
...
func _spawn_fleet_ally_f() -> void:
	## FL-F: sixth SoftNet visual hull. Same visitor-hold grammar. Not a sixth Ship.
	var P0 = load("res://scripts/world/P0Slice.gd")
	if P0 != null and not bool(P0.FL_F_FLEET):
		return
	if _fleet_ally_f != null and is_instance_valid(_fleet_ally_f):
		return
	if get_node_or_null("FleetAllyVisualF") != null:
		_fleet_ally_f = get_node_or_null("FleetAllyVisualF") as Node3D
		return
	var v := Node3D.new()
	v.name = "FleetAllyVisualF"
	v.set_meta("pad_traffic_role", "fleet_ally_f")
	v.set_meta("fleet_member", true)
	v.set_meta("softnet_visual", true)
	v.set_meta("combat_authority", "host")
	v.set_meta("occupy_authority", "host")
	...
	lab.position = Vector3(0, 2.4, 0)
	lab.text = _SoftK.fleet_label()
	lab.modulate = Color(0.55, 1.0, 0.45)
	v.add_child(lab)


func _spawn_fleet_ally_g() -> void:
	## FL-G: seventh SoftNet visual hull. Same visitor-hold grammar. Not a seventh Ship.
	var P0 = load("res://scripts/world/P0Slice.gd")
	if P0 != null and not bool(P0.FL_G_FLEET):
		return
	if _fleet_ally_g != null and is_instance_valid(_fleet_ally_g):
		return
	if get_node_or_null("FleetAllyVisualG") != null:
		_fleet_ally_g = get_node_or_null("FleetAllyVisualG") as Node3D
		return
	var v := Node3D.new()
	v.name = "FleetAllyVisualG"
	v.set_meta("pad_traffic_role", "fleet_ally_g")
	v.set_meta("fleet_member", true)
	v.set_meta("softnet_visual", true)
	v.set_meta("combat_authority", "host")
	v.set_meta("occupy_authority", "host")
	v.set_meta("site_pin", "")
	v.position = Vector3(0.0, 6.5, -20.0)
	add_child(v)
	_fleet_ally_g = v
	_add_marker(v, "Hull")
	if SoftNetSession and SoftNetSession.has_method("bind_visual_puppet"):
	...
	lab.position = Vector3(0, 2.4, 0)
	lab.text = _SoftK.fleet_label()
	lab.modulate = Color(0.4, 0.7, 1.0)
	v.add_child(lab)


func _spawn_fleet_ally_h() -> void:
	## FL-H: eighth SoftNet visual hull. Same visitor-hold grammar. Not an eighth Ship.
	var P0 = load("res://scripts/world/P0Slice.gd")
	if P0 != null and not bool(P0.FL_H_FLEET):
		return
	if _fleet_ally_h != null and is_instance_valid(_fleet_ally_h):
		return
	if get_node_or_null("FleetAllyVisualH") != null:
		_fleet_ally_h = get_node_or_null("FleetAllyVisualH") as Node3D
		return
	var v := Node3D.new()
	v.name = "FleetAllyVisualH"
	v.set_meta("pad_traffic_role", "fleet_ally_h")
	v.set_meta("fleet_member", true)
	v.set_meta("softnet_visual", true)
	v.set_meta("combat_authority", "host")
	v.set_meta("occupy_authority", "host")
...
func _spawn_fleet_ally_j() -> void:
	## FL-J: tenth SoftNet visual hull. Same visitor-hold grammar. Not a tenth Ship.
	var P0 = load("res://scripts/world/P0Slice.gd")
	if P0 != null and not bool(P0.FL_J_FLEET):
		return
	if _fleet_ally_j != null and is_instance_valid(_fleet_ally_j):
		return
	if get_node_or_null("FleetAllyVisualJ") != null:
		_fleet_ally_j = get_node_or_null("FleetAllyVisualJ") as Node3D
		return
	var v := Node3D.new()
	v.name = "FleetAllyVisualJ"
	v.set_meta("pad_traffic_role", "fleet_ally_j")
	v.set_meta("fleet_member", true)
	v.set_meta("softnet_visual", true)
	v.set_meta("combat_authority", "host")
	v.set_meta("occupy_authority", "host")
	...
	lab.position = Vector3(0, 2.4, 0)
	lab.text = _SoftK.fleet_label()
	lab.modulate = Color(0.4, 1.0, 0.85)
	v.add_child(lab)


func _spawn_fleet_ally_k() -> void:
	## FL-K: eleventh SoftNet visual hull. Same visitor-hold grammar. Not an eleventh Ship.
	var P0 = load("res://scripts/world/P0Slice.gd")
	if P0 != null and not bool(P0.FL_K_FLEET):
		return
	if _fleet_ally_k != null and is_instance_valid(_fleet_ally_k):
		return
	if get_node_or_null("FleetAllyVisualK") != null:
		_fleet_ally_k = get_node_or_null("FleetAllyVisualK") as Node3D
		return
	var v := Node3D.new()
	v.name = "FleetAllyVisualK"
	v.set_meta("pad_traffic_role", "fleet_ally_k")
	v.set_meta("fleet_member", true)
	v.set_meta("softnet_visual", true)
	v.set_meta("combat_authority", "host")
	v.set_meta("occupy_authority", "host")
	...
	lab.position = Vector3(0, 2.4, 0)
	lab.text = _SoftK.fleet_label()
	lab.modulate = Color(0.85, 0.45, 1.0)
	v.add_child(lab)


func _spawn_fleet_ally_l() -> void:
	## FL-L: twelfth SoftNet visual hull. Same visitor-hold grammar. Not a twelfth Ship.
	var P0 = load("res://scripts/world/P0Slice.gd")
	if P0 != null and not bool(P0.FL_L_FLEET):
		return
	if _fleet_ally_l != null and is_instance_valid(_fleet_ally_l):
		return
	if get_node_or_null("FleetAllyVisualL") != null:
		_fleet_ally_l = get_node_or_null("FleetAllyVisualL") as Node3D
		return
	var v := Node3D.new()
	v.name = "FleetAllyVisualL"
	v.set_meta("pad_traffic_role", "fleet_ally_l")
	v.set_meta("fleet_member", true)
	v.set_meta("softnet_visual", true)
	v.set_meta("combat_authority", "host")
	v.set_meta("occupy_authority", "host")
	...
	lab.position = Vector3(0, 2.4, 0)
	lab.text = _SoftK.fleet_label()
	lab.modulate = Color(1.0, 0.58, 0.38)
	v.add_child(lab)


func _spawn_fleet_ally_m() -> void:
	## FL-M: thirteenth SoftNet visual hull. Same visitor-hold grammar. Not a thirteenth Ship.
	var P0 = load("res://scripts/world/P0Slice.gd")
	if P0 != null and not bool(P0.FL_M_FLEET):
		return
	if _fleet_ally_m != null and is_instance_valid(_fleet_ally_m):
		return
	if get_node_or_null("FleetAllyVisualM") != null:
		_fleet_ally_m = get_node_or_null("FleetAllyVisualM") as Node3D
		return
	var v := Node3D.new()
	v.name = "FleetAllyVisualM"
	v.set_meta("pad_traffic_role", "fleet_ally_m")
	v.set_meta("fleet_member", true)
	v.set_meta("softnet_visual", true)
	v.set_meta("combat_authority", "host")
	v.set_meta("occupy_authority", "host")
