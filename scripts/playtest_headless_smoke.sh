...
grep -E 'Playtest|SCRIPT ERROR|OS-H|ST-A|FL-N|FLEET MANIFEST 15/15|PASS AR-T|PASS AR-U|PASS AR-V|PASS AR-W|PASS AR-X|PASS AR-Y|PASS AR-Z|PASS PV-C|PASS PC-A|PASS PC-B|WAVE|MINION|XP|LEVEL|CAMP|JUNGLE|REWARD|TITLE|MATCH|QUEUE|READY|PVP|COLONY|SHIP|PERSIST|CRATE|CARGO|kits=' /tmp/pt_mech.log | tail -80 || true
