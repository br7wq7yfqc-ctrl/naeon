...
- **SN-D:** same tag on Clash (`TestArena` / `ClashMatchDirector`) viewer + host arena / Clash pose puppet. Host keeps Pulse / Hack / form. No second physical Clash dummy. AR-H door stays. AR-I CORE match-end does not add a second dummy. Not ENet cluster.
