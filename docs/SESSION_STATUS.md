...
AR-Q: tenth Clash AbilityKit (`gr_coil` / GR Coil) on the same 60×60 TestArena / ClashDirector — gROT symmetric to CX Helix. Same Pulse / utility / probe|surge / Form Cycle slots from EnergyEconomy. SoftKnowledge / HUD `COIL` / `ROT COIL` only. Knowledge ≠ DPS / yield / Pulse / Hack / rank. No cash-shop / P2W / unique weapon. No Paragon card deck. Prior 9 kits stay. ClashModuleBench AR-E SENSOR + AR-K CARGO stay. AR-A…AR-P stay. Host authority. Infection cap 5. `ORBITAL_STATIONS` stays false. No `SITE_*`. No G2–G6.
