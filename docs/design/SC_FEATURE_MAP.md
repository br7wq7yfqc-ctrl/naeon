...
| 9 | Contracts / loops | SessionObjectives; `ContractBoard` | Q-A one pad template; Q-B one alliance-shared occupy/logistics; Q-C optional Learning Node on harvest/deliver | campaigns later | story=power |
