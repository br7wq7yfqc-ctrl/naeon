...
| 14 | Combat | dummy + Clash/MOBA (нативно); бар Predecessor | TestArena / Aexion Clash / Turret; **PV-A** pad TPS PvP + **PV-B** seated-hull Space PvP (same rival, not Clash); **AR-H** pad door → TestArena (not city-map); **SN-D** Clash SoftNet visual host puppet; **AR-K** session bench second catalog option; **AR-L** fifth AbilityKit (CX Lattice); **AR-M** sixth AbilityKit (GR Vein); **AR-N** seventh AbilityKit (CX Prism); **AR-O** eighth AbilityKit (GR Facet); **AR-P** ninth AbilityKit (CX Helix); **AR-Q** tenth AbilityKit (GR Coil); **AR-R** eleventh AbilityKit (CX Spire); **AR-S** twelfth AbilityKit (GR Thorn); **AR-T** minion-wave seed; **AR-U** XP/leveling seed; **AR-V** second-lane wave; **AR-W** third-lane wave; **AR-X** small jungle camp; **AR-Y** rewards pipeline seed | AR-A…AR-Y **built**; **PV-A / PV-B built**; **SN-D built**; **G5 закрыт** | cash-shop of power; Arena Commander |
