...
| 14 | Combat | dummy + Clash/MOBA (нативно); бар Predecessor | TestArena / Aexion Clash / Turret; **PV-A** pad TPS PvP + **PV-B** seated-hull Space PvP (same rival, not Clash); **AR-H** pad door → TestArena (not city-map); **SN-D** Clash SoftNet visual host puppet | AR-A…AR-H **built**; **PV-A / PV-B built**; **SN-D built**; **G5 закрыт** | арена-магазин; Arena Commander |
