...
| 3 | Ship as place (interior, seats, multi-crew) | `InteriorDirector` / `InteriorGenerator`; Seat; F seat→pilot; MC-A `CrewSeat` | seat↔pocket↔hatch EVA; двери ведут в карман/EVA; **MC-A** first crew seat (F/I same pocket) | Phase 2 more seats / roles | фейковые двери |
