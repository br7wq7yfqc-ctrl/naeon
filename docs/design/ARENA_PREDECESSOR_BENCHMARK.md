...
| Phase 3 план | 6–8 heroes / items / matchmaking — **ещё не код**; jungle bite = AR-D + AR-J; items-shop seed = AR-K; fifth kit = AR-L; sixth kit = AR-M; seventh kit = AR-N; eighth kit = AR-O; ninth kit = AR-P; tenth kit = AR-Q; eleventh kit = AR-R; twelfth kit = AR-S (5v5 local = AR-G) |
...
AR-S: двенадцатый Clash AbilityKit (GR Thorn) на существующем `AbilityKitCatalog` / TestArena / ClashDirector — gROT-слот, симметричный CX Spire. Та же грамматика Pulse / utility / probe|surge / Form Cycle. SoftKnowledge / HUD `THORN` only. Prior 11 kits stay. ClashModuleBench AR-E SENSOR + AR-K CARGO stay. AR-A…AR-R, река и jump pads не откатывать. G5 закрыт. Не mint SITE_*. Knowledge не меняет DPS. Дверь: меню → AEXION CLASH → TestArena.
