...
**Дата:** 2026-08-17  
**Движок:** Godot 4.7.2  
**Статус:** ST-B built (2026-08-27). ST-C…ST-F next.  
**Очередь кода:** ST-B extractor + visible Contribution on occupy. NP-C may follow. G2–G6 still locked.
...
Каждый срез playable сам. ST-A built 2026-08-22. ST-B built 2026-08-27 (`PadHarvestExtractor` + HUD Contribution). ST-C next.
...
| Сейчас | Дальше |
|--------|--------|
| ST-B extractor + HUD Contribution | ST-C печать модуля |
