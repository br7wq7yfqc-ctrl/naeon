...
**Статус:** OS-A/OS-B/OS-C built · OS-D в этом срезе. Версия 1.3, 2026-08-17.  
**Движок:** Godot 4.3.  
...
- Почти нет unnamed scatter и силуэта аванпоста с высоты. OS-D: 3 unnamed пада + редкий rock/crate с ~2 км.
- Грунт достаточно читаем, чтобы стоять; детализация низкая.
- S-sink есть. Drag/потолок оболочки — OS-B. Полная аэродинамика — OS-F.
- Три unnamed пада (`Pad_North` class). Силуэт аванпоста — OS-G.
...
Очередь кода: OS-E. Не G2. Не открывать G2–G6 этим баром.
