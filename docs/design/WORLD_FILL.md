...
(`docs/design/TRIPO_ASSET_MANIFEST.md`). Filler may stay code-first, as
Relief / chunks / flora already do. Do not commit `assets/` or `generations/`.
